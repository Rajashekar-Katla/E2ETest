...
public class FileServiceTest {
	...
	private List<FileInformation> prepareData() {
		final FileInformation fileInformation1 = new FileInformationBuilder().withFileName(randomString())
				.withFileExtension(randomString()).withfileMIMEType(MIMEType.CSV.getMimeType()).withFileSize(randomLong()).build();
		...
		final FileInformation fileInformation3 = new FileInformationBuilder().withFileName(randomString())
				.withFileExtension(randomString()).withfileMIMEType(MIMEType.XLS.getMimeType()).withFileSize(randomLong()).build();
